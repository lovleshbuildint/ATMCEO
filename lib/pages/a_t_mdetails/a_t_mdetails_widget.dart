  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final aTMdetailsLatestBankDataResponse = snapshot.data!;
            ...
            body: Container(
              ...
              child: FutureBuilder<ApiCallResponse>(
                ...
                builder: (context, snapshot) {
                  ...
                  final stackATMDetailsResponse = snapshot.data!;
                  return Stack(
                    children: [
                      Column(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            getJsonField(
                                              stackATMDetailsResponse.jsonBody,
                                              r'''$.data.address''',
                                            ).toString(),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final latestBankData = getJsonField(
                                      aTMdetailsLatestBankDataResponse.jsonBody,
                                      r'''$.data''',
                                    ).toList();

  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final mainScreenLatestBankDataResponse = snapshot.data!;
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: LinearPercentIndicator(
                                          percent: FFAppState().targetIncState
                                              ? 0.99
                              ...
                              child: Builder(
                                builder: (context) {
                                  final latestBankData = getJsonField(
                                    mainScreenLatestBankDataResponse.jsonBody,
                                    r'''$.data''',
                                  ).toList();
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    setState(() {
                                      ...
                                      FFAppState().targetIncState = true;
                                    });
                                  },
                                  text: 'Continue',
